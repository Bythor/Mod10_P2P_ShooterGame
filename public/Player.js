...
class Player extends Character {
    ...
    constructor (game) {
        ...
        super(game, width, height, x, y, speed, myImage, myImageDead, score, lives);
    }
    ...
    collide() {
        if (!this.dead) {
            ...
            this.game.lives -= 1; // resta 1 vida 
                super.collide();     
        }      
    }
    }
  ...
  /**
     * Muestra vidas del jugador
     */
const mostrar_lives =() => 
            {
        return document.getElementById("livesli").innerHTML = `Lives: ` + this.game.lives;
                    };