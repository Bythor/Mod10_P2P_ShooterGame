...
class Game {
    ...
    /**
     * Termina el juego, jugador pierde!
     */
    endGame () {
        this.ended = true;       
  ...
  /**
     * Termina el juego, jugador gana!
     */
    youWin () {
        this.ended = true;       
        let youWins = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, YOU_WIN_PICTURE);        
        youWins.render();
    }
    ...
    update () {
        if (!this.ended) {
            mostrar_score();  // Actualiza el score. función definida en main.js
            mostrar_lives();  // Actualiza el score. función definida en main.js
            this.player.update();
 ...
 /**
     * Muestra score del jugador
     */
    mostrar_score =() => 
    {
        return document.getElementById("scoreli").innerHTML = `Score: `+ this.game.score;
            };
