/**
 * Boss al que tenemos que destruir
 */
class Boss extends Character {
    /**
     * @param game {Game} La instancia del juego al que pertenece el Jefe (Boss)
     */
    constructor (game) {
    ...
    collide() {
        ...
        if (!this.dead) {
            setTimeout(() => {
                this.game.score += 1; // suma 1 cuando muere el Boss
                this.game.youWin();   // Jugador gana el juego al matar al Boss
            }, 2000);
            super.collide();            
        }
